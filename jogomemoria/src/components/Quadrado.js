      ...
      document.querySelector(`[id='${index}']`).addEventListener('click',(e) =>{
            ...
            if(select.length  >  1){
                if(select[0].src === select[1].src){
                    ...
                    window.localStorage.setItem('placar',(quantidadeCartas/window.localStorage.getItem('rodadas'))*100)
                    ...
                    console.log("nao sao iguais")
                        ...
                        window.localStorage.setItem('rodadas',parseInt(window.localStorage.getItem('rodadas')) + 1);
